...
class WooCommerce_Quick_Buy_FrontEnd {
    ...
    public function enqueue_style_script(){
		...
		// wp_register_style(WCQB_DB.'_form_style', WCQB_CSS.'general.css');
    ...
    public function get_from_db(){
        ...
        // self::$settings['quick_buy_form'] = get_option(WCQB_DB.'quick_buy_form');
        self::$settings['sp_qb_form_heading'] = get_option(WCQB_DB.'sp_qb_form_heading');
        self::$settings['sp_qb_form_btn_text'] = get_option(WCQB_DB.'sp_qb_form_btn_text');
    }
