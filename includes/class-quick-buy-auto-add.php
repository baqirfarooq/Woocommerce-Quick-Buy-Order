	...
	public function setup_single_product_quick_buy(){
		...
		if(isset($single_auto) && $single_auto == 'true'){
		   if(! empty($single_pos) && ! $single_pos == null){
			   $pos = '';
			   if($single_pos == 'before_form'){$pos = 'woocommerce_before_add_to_cart_form';}
			   if($single_pos == 'after_form'){$pos = 'woocommerce_after_add_to_cart_form';}
			   if($single_pos == 'after_button'){$pos = 'woocommerce_after_add_to_cart_button';}
			   if($single_pos == 'before_button'){$pos = 'woocommerce_before_add_to_cart_button';}
	...
	public function setup_shop_loop_quick_buy(){ 
		...
		if(isset($single_auto) && $single_auto == 'true'){
		   if(! empty($single_pos) && ! $single_pos == null){
			   ...
			   $p = 5;
			   if($single_pos == 'after_button'){$p = 11;}
			   if($single_pos == 'before_button'){$p = 9;}
